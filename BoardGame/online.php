<?php
	if(isset($_GET['adminName'])){
		...
		$userCharas = $_GET['chara'];
		$arrCharas = array();
		$arrCharas = explode(",", $userCharas);
		// print_r($arrUsers);
...
<html>
<head>
	<title>ESL Ninja - Board Game</title>
...
//	for( $boards = 0; $boards < 1; $boards++){
	...
	<div class="answerPanel">
		<h3>Select your answer<span onclick="confirmAnswer()">confirm</span></h3>
	...
	<div class="carContainer">
		...
		for( $i = 1; $i <= $carNumbers; $i++){
			...
			<div id="player<?= $i ?>" class="player">
				...
				<div class="playerImage" style="background-image: url(assets/<?= $adminName ?>/birds/birds-<?= str_pad($arrCharas[$i-1], 2, '0', STR_PAD_LEFT); ?>.png)"></div>
			</div>
	...
	<div class="dice_board">
		<div class="dice_container">
			<section class="dice-container">
				<div id="dice1" class="show-front dice">
		...
		<div class="dice_container">
			<section class="dice-container">
				<div id="dice2" class="show-front dice">
					<figure class="front"></figure>
					<figure class="back"></figure>
					<figure class="right"></figure>
					<figure class="left"></figure>
	...
	<div class="confirmMessage">
		<div class="correctMessage HideItem"></div>
		<div class="wrongMessage HideItem"></div>
	</div>
<audio preload="auto">
